 ...
 */
static __inline uint16_t mavlink_msg_use_rc_simulator_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_use_rc_simulator_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_use_rc_simulator_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_use_rc_simulator_t* use_rc_simulator)
{
...
static __inline void mavlink_msg_use_rc_simulator_send(mavlink_channel_t chan, uint8_t simulator_cmd)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[1];
	_mav_put_uint8_t(buf, 0, simulator_cmd);
 ...
 */
static __inline uint8_t mavlink_msg_use_rc_simulator_get_simulator_cmd(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_use_rc_simulator_decode(const mavlink_message_t* msg, mavlink_use_rc_simulator_t* use_rc_simulator)
{
