...
static __inline void mavlink_msg_keycode_request_send(mavlink_channel_t chan, uint8_t device_name)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[1];
	_mav_put_uint8_t(buf, 0, device_name);
 ...
 */
static __inline uint8_t mavlink_msg_keycode_request_get_device_name(const mavlink_message_t* msg)
{
