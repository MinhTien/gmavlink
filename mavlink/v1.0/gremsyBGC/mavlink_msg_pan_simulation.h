 ...
 */
static __inline uint16_t mavlink_msg_pan_simulation_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_pan_simulation_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_pan_simulation_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_pan_simulation_t* pan_simulation)
{
...
static __inline void mavlink_msg_pan_simulation_send(mavlink_channel_t chan, int16_t pan, uint8_t channel)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[3];
	_mav_put_int16_t(buf, 0, pan);
 ...
 * @return pan value
 */
static __inline int16_t mavlink_msg_pan_simulation_get_pan(const mavlink_message_t* msg)
{
 ...
 * @return pan channel
 */
static __inline uint8_t mavlink_msg_pan_simulation_get_channel(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_pan_simulation_decode(const mavlink_message_t* msg, mavlink_pan_simulation_t* pan_simulation)
{
