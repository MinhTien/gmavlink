 ...
 */
static inline uint16_t mavlink_msg_motors_control_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t command)
{
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_motors_control_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static inline uint16_t mavlink_msg_motors_control_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_motors_control_t* motors_control)
{
...
static inline void mavlink_msg_motors_control_send(mavlink_channel_t chan, uint8_t command)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[1];
	_mav_put_uint8_t(buf, 0, command);
 ...
 */
static inline uint8_t mavlink_msg_motors_control_get_command(const mavlink_message_t* msg)
{
 ...
 */
static inline void mavlink_msg_motors_control_decode(const mavlink_message_t* msg, mavlink_motors_control_t* motors_control)
{
