 ...
 */
static __inline uint16_t mavlink_msg_gyro_calib_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t status)
{
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_gyro_calib_status_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_gyro_calib_status_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_gyro_calib_status_t* gyro_calib_status)
{
...
static __inline void mavlink_msg_gyro_calib_status_send(mavlink_channel_t chan, uint8_t status)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[1];
	_mav_put_uint8_t(buf, 0, status);
 ...
 */
static __inline uint8_t mavlink_msg_gyro_calib_status_get_status(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_gyro_calib_status_decode(const mavlink_message_t* msg, mavlink_gyro_calib_status_t* gyro_calib_status)
{
