...
static __inline void mavlink_msg_roll_simulation_send(mavlink_channel_t chan, int16_t roll, uint8_t channel)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[3];
	_mav_put_int16_t(buf, 0, roll);
 ...
 * @return roll channel
 */
static __inline uint8_t mavlink_msg_roll_simulation_get_channel(const mavlink_message_t* msg)
{
