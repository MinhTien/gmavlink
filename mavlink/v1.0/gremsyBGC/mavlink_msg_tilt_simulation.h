 ...
 */
static __inline uint16_t mavlink_msg_tilt_simulation_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static __inline uint16_t mavlink_msg_tilt_simulation_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
 ...
 */
static __inline uint16_t mavlink_msg_tilt_simulation_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_tilt_simulation_t* tilt_simulation)
{
...
static __inline void mavlink_msg_tilt_simulation_send(mavlink_channel_t chan, int16_t tilt, uint8_t channel)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[3];
	_mav_put_int16_t(buf, 0, tilt);
 ...
 * @return tilt value
 */
static __inline int16_t mavlink_msg_tilt_simulation_get_tilt(const mavlink_message_t* msg)
{
 ...
 * @return tilt channel
 */
static __inline uint8_t mavlink_msg_tilt_simulation_get_channel(const mavlink_message_t* msg)
{
 ...
 */
static __inline void mavlink_msg_tilt_simulation_decode(const mavlink_message_t* msg, mavlink_tilt_simulation_t* tilt_simulation)
{
